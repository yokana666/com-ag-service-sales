...
{
    public class SMVGarmentByUnitReportControllerTest : BaseMonitoringControllerTest<SMVGarmentByUnitReportController, SMVGarmentByUnitReportViewModel, ISMVGarmentByUnitReport>
    {
    }
