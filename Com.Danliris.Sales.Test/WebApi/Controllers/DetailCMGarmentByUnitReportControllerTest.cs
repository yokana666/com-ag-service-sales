...
{
    public class DetilCMGarmentByUnitReportControllerTest : BaseMonitoringControllerTest<DetailCMGarmentByUnitReportController, DetailCMGarmentByUnitReportViewModel, IDetailCMGarmentByUnitReport>
    {
    }
