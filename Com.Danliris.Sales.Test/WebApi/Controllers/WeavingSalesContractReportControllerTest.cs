...
{
    public class WeavingSalesContractReportControllerTest
    {
        private const string ENTITY = "WeavingSalesContractReportController";
        protected Mock<IServiceProvider> GetServiceProviderMock(SalesDbContext dbContext)
        {
            ...
            var weavingLogic = new WeavingSalesContractLogic(serviceProviderMock.Object, identityService, dbContext);

            serviceProviderMock
                .Setup(x => x.GetService(typeof(WeavingSalesContractLogic)))
                .Returns(weavingLogic);
        ...
        protected virtual WeavingSalesContractDataUtil DataUtil(WeavingSalesContractFacade facade, SalesDbContext dbContext = null)
        {
            WeavingSalesContractDataUtil dataUtil = Activator.CreateInstance(typeof(WeavingSalesContractDataUtil), facade) as WeavingSalesContractDataUtil;
            return dataUtil;
        }

        protected WeavingSalesContractReportController GetController(WeavingSalesContractReportFacade facade)
        {
            ...
            WeavingSalesContractReportController controller = (WeavingSalesContractReportController)Activator.CreateInstance(typeof(WeavingSalesContractReportController), facade);
        ...
        public async Task GetReportAll_WithoutException_ReturnOK()
        {
            ...
            WeavingSalesContractReportFacade facade = new WeavingSalesContractReportFacade(serviceProvider, dbContext);
            WeavingSalesContractFacade fpFacade = new WeavingSalesContractFacade(serviceProvider, dbContext);
