...
{
    public class CostCalculationBySectionReportControllerTest : BaseMonitoringControllerTest<CostCalculationBySectionReportController, CostCalculationGarmentBySectionReportViewModel, ICostCalculationGarmentBySectionReport>
    {
    }
