...
{
    public class CostCalculationGarmentApprovalReportControllerTest : BaseMonitoringControllerTest<CostCalculationGarmentApprovalReportController, CostCalculationGarmentApprovalReportViewModel, ICostCalculationGarmentApprovalReport>
    {
    }
