...
{
    public class ProfitGarmentBySectionReportControllerTest : BaseMonitoringControllerTest<ProfitGarmentBySectionReportController, ProfitGarmentBySectionReportViewModel, IProfitGarmentBySectionReport>
    {
    }
