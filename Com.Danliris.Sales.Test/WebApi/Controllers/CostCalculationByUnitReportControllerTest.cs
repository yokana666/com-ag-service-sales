...
{
    public class CostCalculationByUnitReportControllerTest : BaseMonitoringControllerTest<CostCalculationByUnitReportController, CostCalculationGarmentByUnitReportViewModel, ICostCalculationGarmentByUnitReport>
    {
    }
