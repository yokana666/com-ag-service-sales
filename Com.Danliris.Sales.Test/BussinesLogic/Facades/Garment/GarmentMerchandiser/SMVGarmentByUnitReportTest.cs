...
{
    public class SMVGarmentByUnitReportTest 
   {
        private const string ENTITY = "SMVGarmentByUnitReport";
        ...
        public async void Get_Report_Success()
        {
            ...
            ISMVGarmentByUnitReport smvGarmentByUnitReport = new SMVGarmentByUnitReportFacade(serviceProvider, dbContext);
            ...
            var Response = smvGarmentByUnitReport.Read(filter: JsonConvert.SerializeObject(filter));
        ...
        public async void Get_Excel_Success()
        {
            ...
            var Response = smvGarmentByUnitReport.GenerateExcel(filter: JsonConvert.SerializeObject(filter));
