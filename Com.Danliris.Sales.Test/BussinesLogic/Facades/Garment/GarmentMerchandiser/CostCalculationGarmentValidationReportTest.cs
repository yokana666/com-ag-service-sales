...
{
    public class CostCalculationGarmentValidationReportTest 
   {
        private const string ENTITY = "CostCalculationGarmentValidationReport";
        ...
        protected virtual Mock<IServiceProvider> GetServiceProviderMock(SalesDbContext dbContext)
        {
            ...
            CostCalculationGarmentValidationReportLogic costcalculationGarmentValidationReportLogic = new CostCalculationGarmentValidationReportLogic(identityService, dbContext);
            ...
            serviceProviderMock
                .Setup(x => x.GetService(typeof(CostCalculationGarmentValidationReportLogic)))
                .Returns(costcalculationGarmentValidationReportLogic);
        ...
        public async void Get_Report_Success()
        {
            ...
            var Response = CCGarmentValidationReport.Read(filter: JsonConvert.SerializeObject(filter));
