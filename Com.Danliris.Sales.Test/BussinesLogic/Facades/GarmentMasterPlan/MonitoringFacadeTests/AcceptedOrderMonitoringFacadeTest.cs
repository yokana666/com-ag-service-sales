...
{
    public class AcceptedOrderMonitoringFacadeTest
    {
        private const string ENTITY = "AcceptedOrderMonitoring";
        ...
        protected virtual Mock<IServiceProvider> GetServiceProviderMock(SalesDbContext dbContext)
        {
            ...
            serviceProviderMock
                .Setup(x => x.GetService(typeof(AcceptedOrderMonitoringLogic)))
                .Returns(new AcceptedOrderMonitoringLogic(identityService, dbContext));
