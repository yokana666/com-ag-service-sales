...
namespace Com.Danliris.Service.Sales.Lib.PDFTemplates
{
    public class WeavingSalesContractModelPDFTemplate
    {
        public MemoryStream GeneratePdfTemplate(WeavingSalesContractViewModel viewModel, int timeoffset)
        {
            ...
            tableBody.AddCell(bodyContentLeft);
            bodyContentLeft.Phrase = new Phrase(": " + viewModel.OrderQuantity.ToString("N0") + " (" + QuantityToText + ") " + uomLocal, normal_font);
            tableBody.AddCell(bodyContentLeft);
            ...
            tableBody.AddCell(bodyContentLeft);
            bodyContentLeft.Phrase = new Phrase(": " + viewModel.PieceLength.Replace("\n", "\n  "), normal_font);
            tableBody.AddCell(bodyContentLeft);
