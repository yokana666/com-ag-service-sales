...
{
    public class FinishingPrintingSalesContractExportPDFTemplate
    {
        public MemoryStream GeneratePdfTemplate(FinishingPrintingSalesContractViewModel viewModel, int timeoffset)
        {
            ...
            tableBody.AddCell(bodyContentLeft);
            bodyContentLeft.Phrase = new Phrase(": " + viewModel.OrderQuantity + " ( " + QuantityToText + " ) " + uom, normal_font);
            tableBody.AddCell(bodyContentLeft);
            ...
            if (viewModel.Agent.Id != 0)
            {
                ...
                #region agentBody
                string agentFirstParagraphString = "This is to confirm that your order for " + viewModel.Buyer.Name + " concerning " + viewModel.OrderQuantity + " ( " + QuantityToText + ") " + uom + " of " + viewModel.Commodity.Name + viewModel.CommodityDescription;
                ...
                //string agentFirstParagraphStringDescription = viewModel.Commodity.Name + viewModel.CommodityDescription;
