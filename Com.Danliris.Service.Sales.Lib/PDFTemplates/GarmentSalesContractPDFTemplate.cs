    ...
    public class GarmentSalesContractPDFTemplate
    {
        ...
        public MemoryStream GeneratePdfTemplate(GarmentSalesContractViewModel viewModel, IGarmentSalesContract facade, int timeoffset, Dictionary<string, object> buyer, Dictionary<string, object> bank, string rate)
        {
            ...
            bool isDollar = rate.Equals("1");
                ...
                string codeNoString = "FM-02-PJ-01-04";
    ...
    class GarmentSalesContractPDFTemplatePageEvent : PDFPages
    {
        public override void OnStartPage(PdfWriter writer, Document document)
        {
            ...
            string[] headOffices = {
                ...
                "TELP. (0271) 714400, 7652913, FAX. : (0271) 735222, 740777, PO BOX 166 SOLO 57100",
            ...
            //cb.ShowTextAligned(PdfContentByte.ALIGN_CENTER, "CERTIFICATE ID19 / 05073", width - (imageIso.ScaledWidth / 2) - marginRight, height - imageIso.ScaledHeight - marginTop + 60 - 5, 0);
