...
namespace Com.Danliris.Service.Sales.Lib.BusinessLogic.Facades.CostCalculationGarments
{
    public class CostCalculationGarmentBySectionReportFacade : ICostCalculationGarmentBySectionReport
    {
        ...
        public Tuple<List<CostCalculationGarmentBySectionReportViewModel>, int> Read(int page = 1, int size = 25, string filter = "{}")
        {
            ...
            Pageable<CostCalculationGarmentBySectionReportViewModel> pageable = new Pageable<CostCalculationGarmentBySectionReportViewModel>(data, page - 1, size);
            List<CostCalculationGarmentBySectionReportViewModel> Data_ = pageable.Data.ToList<CostCalculationGarmentBySectionReportViewModel>();
