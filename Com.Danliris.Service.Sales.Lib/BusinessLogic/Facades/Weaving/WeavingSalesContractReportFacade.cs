...
{
    public class WeavingSalesContractReportFacade
    {
        ...
        public WeavingSalesContractReportFacade(IServiceProvider serviceProvider, SalesDbContext dbContext)
        {
        ...
        public IQueryable<WeavingSalesContractReportViewModel> GetReportQuery(string no, string buyerCode, string comodityCode, DateTime? dateFrom, DateTime? dateTo, int offset)
        {
            DateTime DateFrom = dateFrom == null ? new DateTime(1970, 1, 1) : (DateTime)dateFrom;
            DateTime DateTo = dateTo == null ? DateTime.Now : (DateTime)dateTo;

            var Query = (from a in DbContext.WeavingSalesContract
                             //Conditions
                         ...
                         select new WeavingSalesContractReportViewModel
                         {
        ...
        public Tuple<List<WeavingSalesContractReportViewModel>, int> GetReport(string no, string buyerCode, string comodityCode, DateTime? dateFrom, DateTime? dateTo, int page, int size, string Order, int offset)
        {
            ...
            Pageable<WeavingSalesContractReportViewModel> pageable = new Pageable<WeavingSalesContractReportViewModel>(Query, page - 1, size);
            List<WeavingSalesContractReportViewModel> Data = pageable.Data.ToList<WeavingSalesContractReportViewModel>();
